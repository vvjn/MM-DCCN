...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask, img=None,
                previous_input=None):
        # Args Checks
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, img=None, memory_lengths=None):
        """
        ...
        for i in range(self.num_layers):
            ...
            output, attn, all_input \
                = self.transformer_layers[i](output, src_memory_bank,
                                             src_pad_mask, tgt_pad_mask, img=img,
