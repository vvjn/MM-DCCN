...
def train_opts(parser):
    ...
    group.add_argument('-pre_dp', type=float, default=0,
                       help="Image dropout before linear.")
    group.add_argument('-after_dp', type=float, default=0,
                       help="Image dropout after Relu.")
...
def mmod_finetune_opts(parser):
    ...
    parser.add_argument('-path_to_train_img_mask', required=True,
                        help="""Path to npy file containing training image mask""")
    parser.add_argument('-path_to_valid_img_mask', required=True,
                        help="""Path to npy file containing validation image mask""")
    parser.add_argument('-path_to_train_attr', required=True,
                        help="""Path to npy file containing training image objects""")
    parser.add_argument('-path_to_valid_attr', required=True,
                        help="""Path to npy file containing validation image objects""")
    ...
    parser.add_argument('--multimodal_model_type', required=True, type=str,
                        choices=['generator', 'bank', 'bank+generator', 'imgw', 'dcap'],
...
def mmod_finetune_translate_opts(parser):
    ...
    parser.add_argument('-path_to_test_img_mask', required=True,
                        help="""Path to npy file containing test image mask""")
    parser.add_argument('-path_to_test_attr', required=True,
                        help="""Path to npy file containing training image attributes""")
    parser.add_argument('--multimodal_model_type', required=True, type=str,
                        choices=['generator', 'bank', 'bank+generator', 'imgw', 'dcap'],
                        help="""Multi-modal NMT model type.""")
    parser.add_argument('-mmod_generator_add', type=float, default=0.0,
